...
#pragma acc parallel present(u0_real,u0_imag,u1_real,u1_imag,twiddle)
{
...
#pragma acc parallel present(u_real,u_imag)
  {
    u_real[0] = m;
    u_imag[0] = 0.0;
  }
...
#pragma acc parallel present(gty1_real,gty1_imag,gty2_real,gty2_imag, u1_real,u1_imag,u_real,u_imag)
  {
#pragma acc loop gang independent
    for (k = 0; k < d3; k++) {
#pragma acc loop vector independent
...
#pragma acc parallel present(gty1_real,gty1_imag,gty2_real,gty2_imag,\
...
static void checksum(int i, int d1, int d2, int d3)
{
  ...
  //#pragma acc update host(u1_real,u1_imag)
#pragma acc parallel present(u1_real,u1_imag)
  {
